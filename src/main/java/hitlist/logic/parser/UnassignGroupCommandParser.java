...
/**
 * Parses input arguments and creates a new UnassignGroupCommand object.
 */
public class UnassignGroupCommandParser implements Parser<UnassignGroupCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the UnassignGroupCommand
     * and returns a UnassignGroupCommand object for execution.
     *
     * @throws ParseException if the user input does not conform the expected format
     */
    @Override
    public UnassignGroupCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_GROUP)
            ...
            throw new ParseException(String.format(
                    ...
                    UnassignGroupCommand.MESSAGE_USAGE));
        }
        ...
        return new UnassignGroupCommand(personName, groupName);
    }
