...
import hitlist.commons.util.ConfigUtil;
...
import hitlist.storage.HitListStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing HitList ]===========================");
        super.init();
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s HitList and {@code userPrefs}. <br>
     * The data from the sample HitList will be used instead if {@code storage}'s HitList is not found,
     * or an empty HitList will be used instead if errors occur when reading {@code storage}'s HitList.
     */
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting HitList " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping HitList ] =============================");
        try {
