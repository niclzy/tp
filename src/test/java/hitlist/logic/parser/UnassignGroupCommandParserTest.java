...
public class UnassignGroupCommandParserTest {

    private UnassignGroupCommandParser parser = new UnassignGroupCommandParser();

    @Test
    public void parse_allFieldsPresent_success() {
        UnassignGroupCommand expectedCommand =
                new UnassignGroupCommand(new Name(VALID_NAME_AMY), new GroupName(VALID_GROUP_NAME_STUDENTS));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, UnassignGroupCommand.MESSAGE_USAGE);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_AMY + GROUP_NAME_DESC_STUDENTS,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, UnassignGroupCommand.MESSAGE_USAGE));
    }
}
